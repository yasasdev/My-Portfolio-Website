...
const Services = () => {
  return (
    ...
    >
      <p className="text-center mb-3 text-xs uppercase tracking-[0.3em] text-accent">What I offer</p>
      <h2 className="text-center text-4xl font-Ovo dark:text-white">My Services</h2>
