  ...
  return (
    <div className="mt-20">
      <div className="text-center">
        <Image src={isDarkMode ? assets.yasas_logo_dark : assets.yasas_logo} alt="Logo" className="w-28 mx-auto mb-2" />
      ...
      >
        <p className="text-gray-500">© {year} Yasas Lekamge. All rights reserved.</p>
